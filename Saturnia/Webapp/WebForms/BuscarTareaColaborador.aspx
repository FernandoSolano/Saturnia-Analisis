    ...
    <div style="margin-top:20px;">
        <asp:GridView ID="GridViewTasks" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridViewTasks_SelectedIndexChanged" OnRowCommand="GridViewTask_RowCommand">
            <Columns>
                ...
                <asp:ButtonField ButtonType="Link" CommandName="Duplicar" Text="Duplicar" HeaderText="Acciones" />
                <asp:ButtonField ButtonType="Link" CommandName="Eliminar" Text="Eliminar" HeaderText="Acciones" />
            </Columns>
        </asp:GridView>
    </div>
